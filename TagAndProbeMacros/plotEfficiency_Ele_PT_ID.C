void plotEfficiency_Ele_PT_ID(TString triggerFile){

TFile *f1 = TFile::Open("DY2021_PT_eff_tightid_nominal.root");
TFile *f2 = TFile::Open("DY2021_PT_eff_mediumid_nominal.root");
TFile *f3 = TFile::Open("DY2021_PT_eff_mvawp90id_nominal.root");
TFile *f4 = TFile::Open("DY2021_PT_eff_mvawp80id_nominal.root");
...
//  c->SetLogx();
  ...
  mg->GetYaxis()->SetTitleOffset(1.4);
   ...
   legend->AddEntry(gra_2018A,"tight id","p");
   legend->AddEntry(gra_2018B,"medium id","p");
 //  legend->AddEntry(gra_2018B,"2021","p");
 //  legend->AddEntry(gra_2018C,"2023","p");
   legend->AddEntry(gra_2018C,"mvawp90","p");
   legend->AddEntry(gra_2018D,"mvawp80","p");
   legend->Draw();
