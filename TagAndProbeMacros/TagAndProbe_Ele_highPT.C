...
//   std::cout<< "total events : "<<nentries<<endl;
   ...
   double pt_bins_Ele115[19] = {0,110,115,116,117,119,122,125,130,140,150,160,175,200,250,300,400,500,1000};
   double pt_bins_Ele50[15] = {0,50,51,52,53,55,57,60,65,70,80,100,150,200,300};
...
// HLT Ele50
   ...
   TH1F *h_Ele50_PU_total = new TH1F("Ele50_PU_total","Ele50_pu",7,PU_bins);
   ...
   TH1F *h_Ele50_PU_pass = new TH1F("Ele50_PU_pass","Ele50_pu",7,PU_bins);
...
// HLT Ele115
   ...
   TH1F *h_Ele115_pt_total = new TH1F("Ele115_pt_total","Ele115_pt",18,pt_bins_Ele115);
   TH1F *h_Ele115_PU_total = new TH1F("Ele115_PU_total","Ele115_pu",7,PU_bins);
   TH1F *h_Ele115_eta_total = new TH1F("Ele115_eta_total","Ele115_eta",18,eta_bins);
   TH1F *h_Ele115_pt_pass = new TH1F("Ele115_pt_pass","Ele115_pt",18,pt_bins_Ele115);
   TH1F *h_Ele115_PU_pass = new TH1F("Ele115_PU_pass","Ele115_pu",7,PU_bins);
   TH1F *h_Ele115_eta_pass = new TH1F("Ele115_eta_pass","Ele115_eta",18,eta_bins);
   ...
   //   if (Z_candLV.M()<zMassL || Z_candLV.M() > zMassR) continue;
      ...
      if(ele_pt->at(second)>58)h_Ele50_PU_pass->Fill(nPV); 
      }
      ...
      if(ele_pt->at(second)>123)h_Ele115_PU_pass->Fill(nPV);
      }
